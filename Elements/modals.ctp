    ...
    <div class="modal-dialog">
        <div class="modal-content">
                        ...
                        <div class="row" style="margin-left: 1px;margin-right: -1px;">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <button class="unmask btn btn-secondary" type="button" title="Afficher le mot de passe">Afficher</button>
                                </div>
                            </div>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="text-center float-left mt-2"><h6><a class="text-dark" data-dismiss="modal" href="#" data-toggle="modal" data-target="#lostpasswd"><?= $Lang->get('USER__PASSWORD_FORGOT_LABEL') ?></a></h6></div>
                    </div>
                    <div class="col-lg-4">
                        <button type="submit" class="btn btn-secondary button float-right"><?= $Lang->get('USER__LOGIN') ?></button>
                        </form>
                    </div>
                </div>
            </div>
